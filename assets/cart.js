  ...
  constructor() {
    ...
    this.addEventListener("click", (event) => {
      ...
      if (
        ...
        const bundleItems = document.querySelector(
          `[data-prod="${this.dataset.bundle}"]`
        );
        if (bundleItems) {
          const dataIndexValue = bundleItems.getAttribute("data-index");
          if (dataIndexValue !== null)
            console.log("data index of bundle", dataIndexValue);
      ...
      /* Ends auto remove the bundle if it has bundle items */
    });
  }
}
